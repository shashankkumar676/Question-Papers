(function(){GateCardsController = RouteController.extend({
  subscriptions: function () {
    // set up the subscriptions for the route and optionally
    // wait on them like this:
    //
     this.subscribe('mechanics', this.params._id);this.subscribe('drawing', this.params._id);
    //
