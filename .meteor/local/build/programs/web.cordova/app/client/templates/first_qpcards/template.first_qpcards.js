...
Template["FirstQpcards"] = new Template("Template.FirstQpcards", (function() {
  ...
  return HTML.BODY({
    ...
    return [ "\n        ", HTML.DIV({
      ...
      href: function() {
        return [ "/first_qpapers/", Spacebars.mustache(view.lookup("title_val")) ];
      },
      id: "show_qp"
    }, "\n              ", HTML.BUTTON({
