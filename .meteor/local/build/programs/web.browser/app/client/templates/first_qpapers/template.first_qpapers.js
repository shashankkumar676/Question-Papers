(function(){
Template.__checkName("FirstQpapers");
Template["FirstQpapers"] = new Template("Template.FirstQpapers", (function() {
  var view = this;
  return HTML.BODY({
    id: "body-first_qpapers"
  }, "\n    ", HTML.DIV({
    id: "first_qpapers"
    ...
    "class": "qp_img"
  }, "\n          ", Blaze.View("lookup:first_qp_png", function() {
    return Spacebars.makeRaw(Spacebars.mustache(view.lookup("first_qp_png")));
